...
call sp_agregarCliente('Emanuel','Aguilar','231231+321','Zacapa','746252');
...
CALL sp_EditarCliente(2, 'catrina', 'castro', '41343513', 'Peten', '1455676474');
...
-- Agregar: Productos
DELIMITER $$
CREATE PROCEDURE sp_AgregarProducto(IN nom VARCHAR(50),IN des VARCHAR(100),IN preuni DECIMAL(10,2),IN prema DECIMAL(10,2),IN preco DECIMAL(10,2),IN ima LONGBLOB,IN disId INT,IN catId INT)
BEGIN
...
BEGIN
    SELECT
        P.productoId, P.nombreProducto, P.precioVentaUnitario, P.precioVentaMayor, P.precioCompra, P.imagenProducto
		FROM Productos P
		WHERE productoId = proId;
END $$
DELIMITER ;
