...
public class Producto {
    ...
    public Producto(int productoId, String nombreProducto, String descripcionProductos, int cantidadStock, double precioVentaUnitario, double precioVentaMayor, double precioCompra, Blob imagenProducto, int distribuidorId, int categoriaProductoId) {
    ...
    public void setDescripcionProductos(String descripcionProducto) {
